#!/usr/bin/env python
"""
This script generates the histogram for the delayed outgoing JFK flights
...
def main():
    ...
    file_path = '../../data/delay_bins_outgoing/part-00000'
    ...
    plt.title('Departure Delays for Outgoing Flights (binned by half hour)')
    ...
    plt.savefig("../../plots/histogram_outgoing_delays.png")
